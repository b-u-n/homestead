    ...
    <View style={styles.container}>
      ...
      <View style={styles.explanationBox}>
        <Text style={styles.explanationText}>
          {`When you feel like you just need to talk, that's what we're here for.\n\nShare what's on your mind. Other users can respond to earn the hearts you offer. Responding to others will earn you hearts back and help your post get noticed faster.`}
        </Text>
      </View>

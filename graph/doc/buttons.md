...
Prose source for the Buttons surface of the Homestead application. The full text lives at `/md/BUTTONS.md`. This node is the typed pointer used by spec/component/concept nodes that reference this doc.

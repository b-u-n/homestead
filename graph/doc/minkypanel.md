...
file: /md/MINKYPANEL.md
---

## Summary

Prose source for the Minkypanel surface of the Homestead application. The full text lives at `/md/MINKYPANEL.md`. This node is the typed pointer used by spec/component/concept nodes that reference this doc.

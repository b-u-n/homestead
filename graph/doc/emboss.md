...
Prose source for the Emboss surface of the Homestead application. The full text lives at `/md/EMBOSS.md`. This node is the typed pointer used by spec/component/concept nodes that reference this doc.

...
file: /md/WEBSOCKETS.md
---

## Summary

Prose source for the Websockets surface of the Homestead application. The full text lives at `/md/WEBSOCKETS.md`. This node is the typed pointer used by spec/component/concept nodes that reference this doc.

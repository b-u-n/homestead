...
file: /md/CUSTOMIZATION.md
---

## Summary

Prose source for the Customization surface of the Homestead application. The full text lives at `/md/CUSTOMIZATION.md`. This node is the typed pointer used by spec/component/concept nodes that reference this doc.

...
Prose source for the Architecture surface of the Homestead application. The full text lives at `/md/ARCHITECTURE.md`. This node is the typed pointer used by spec/component/concept nodes that reference this doc.

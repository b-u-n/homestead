...
Prose source for the Bazaar surface of the Homestead application. The full text lives at `/md/BAZAAR.md`. This node is the typed pointer used by spec/component/concept nodes that reference this doc.

...
file: /md/WOOLBUTTONS.md
---

## Summary

Prose source for the Woolbuttons surface of the Homestead application. The full text lives at `/md/WOOLBUTTONS.md`. This node is the typed pointer used by spec/component/concept nodes that reference this doc.

...
Prose source for the Roles surface of the Homestead application. The full text lives at `/md/ROLES.md`. This node is the typed pointer used by spec/component/concept nodes that reference this doc.

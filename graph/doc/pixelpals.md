...
file: /md/pixelpals.md
---

## Summary

Prose source for the Pixelpals surface of the Homestead application. The full text lives at `/md/pixelpals.md`. This node is the typed pointer used by spec/component/concept nodes that reference this doc.

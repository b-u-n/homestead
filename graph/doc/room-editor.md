...
file: /md/ROOM_EDITOR.md
---

## Summary

Prose source for the Room Editor surface of the Homestead application. The full text lives at `/md/ROOM_EDITOR.md`. This node is the typed pointer used by spec/component/concept nodes that reference this doc.

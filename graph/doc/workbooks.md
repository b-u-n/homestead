...
file: /md/WORKBOOKS.md
---

## Summary

Prose source for the Workbooks surface of the Homestead application. The full text lives at `/md/WORKBOOKS.md`. This node is the typed pointer used by spec/component/concept nodes that reference this doc.

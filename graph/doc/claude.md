...
Prose source for the Claude surface of the Homestead application. The full text lives at `/CLAUDE.md`. This node is the typed pointer used by spec/component/concept nodes that reference this doc.

...
Prose source for the Hearts surface of the Homestead application. The full text lives at `/md/HEARTS.md`. This node is the typed pointer used by spec/component/concept nodes that reference this doc.

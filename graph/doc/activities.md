...
file: /md/ACTIVITIES.md
---

## Summary

Prose source for the Activities surface of the Homestead application. The full text lives at `/md/ACTIVITIES.md`. This node is the typed pointer used by spec/component/concept nodes that reference this doc.

...
Prose source for the Badges surface of the Homestead application. The full text lives at `/md/BADGES.md`. This node is the typed pointer used by spec/component/concept nodes that reference this doc.

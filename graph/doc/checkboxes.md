...
file: /md/CHECKBOXES.md
---

## Summary

Prose source for the Checkboxes surface of the Homestead application. The full text lives at `/md/CHECKBOXES.md`. This node is the typed pointer used by spec/component/concept nodes that reference this doc.

...
Prose source for the Items surface of the Homestead application. The full text lives at `/md/items.md`. This node is the typed pointer used by spec/component/concept nodes that reference this doc.

...
Prose source for the Flows surface of the Homestead application. The full text lives at `/md/FLOWS.md`. This node is the typed pointer used by spec/component/concept nodes that reference this doc.
